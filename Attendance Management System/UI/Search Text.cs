...
{
    class Search_Text : TextBox
    {
        public static Search_Text AddIcon(TextBox textbox, Image icon)
        {
            if (icon != null)
            {
                return new Search_Text(textbox, icon);
            }
            else
            {
                return null;
        ...
        private Search_Text(TextBox textbox, Image icon)
        {
